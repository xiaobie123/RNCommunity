...
class MyBottomSheet extends Component {
  ...
  render() {
    const actionSheets = this.props.items.map((item, i) => {
      return (
        <TouchableOpacity
          key={i}
          ...
          onPress={item.click}
        >
          <Text style={[styles.actionItemTitle, this.props.itemTitleStyle]}>{item.title}</Text>
        </TouchableOpacity>
      );
    });
    return (
        ...
        <View style={styles.modalStyle}>
          <View style={styles.subView}>
            <View style={styles.itemContainer}>
              <Text style={[styles.actionTitle, this.props.actionTitleStyle]}>{this.props.modalTitle}</Text>
              {actionSheets}
            </View>
            <View style={[styles.itemContainer]}>
              <TouchableOpacity
